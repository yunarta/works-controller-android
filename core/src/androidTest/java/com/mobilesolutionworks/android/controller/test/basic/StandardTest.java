    ...
    public void testRetainControllerAfterRotation() throws InterruptedException {
        ...
        onView(isRoot()).perform(new PerformRootAction() {
            ...
            public void perform(UiController uiController, View view) {
                ...
                TestWorksFragment fragment = (TestWorksFragment) manager.findFragmentById(R.id.fragment_container);
        ...
        onView(isRoot()).perform(new PerformRootAction() {
            ...
            public void perform(UiController uiController, View view) {
                ...
                TestWorksFragment fragment = (TestWorksFragment) activity.getSupportFragmentManager().findFragmentById(R.id.fragment_container);
