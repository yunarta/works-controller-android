...
class HostWorksControllerActivity : WorksActivity(), GetController<HostWorksControllerActivity.ActivityControllerImpl> {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        controller = HostWorksController.create(this, 0, null, ::ActivityControllerImpl)
